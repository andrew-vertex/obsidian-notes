...
### AI应用开发/Java 转 AI 应用开发
- [[1. 技术研发/AI应用开发/Java 转 AI 应用开发/Java 后端转 AI 应用开发学习路线.md|Java 后端转 AI 应用开发学习路线]]
...
### AI应用开发/Agent
- [[1. 技术研发/AI应用开发/Agent/吴恩达 Agentic AI 课程笔记.md|吴恩达 Agentic AI 课程笔记]]

### AI应用开发/Hello-Agents
- [[1. 技术研发/AI应用开发/Hello-Agents/index.md|index]]

### AI应用开发/Hello-Agents/第一部分：智能体与语言模型基础
- [[1. 技术研发/AI应用开发/Hello-Agents/第一部分：智能体与语言模型基础/第一章 初识智能体.md|第一章 初识智能体]]

### AI应用开发/Java-to-AI
- [[1. 技术研发/AI应用开发/Java-to-AI/Java-Go 开发者 AI 应用开发与 Agent 学习路线.md|Java-Go 开发者 AI 应用开发与 Agent 学习路线]]
...
- [[2. 实用工具/Mac效率工具/Mole 安装使用最佳实践.md|Mole 安装使用最佳实践]]
- [[2. 实用工具/Mac效率工具/claude-obsidian 插件使用指南.md|claude-obsidian 插件使用指南]]
- [[2. 实用工具/Mac效率工具/macOS Keychain 与 zsh API Key 管理最佳实践.md|macOS Keychain 与 zsh API Key 管理最佳实践]]
- [[2. 实用工具/Mac效率工具/macOS tmux 安装使用与 AI 研发工作流最佳实践.md|macOS tmux 安装使用与 AI 研发工作流最佳实践]]
...
- [[2. 实用工具/AI工具手册/Codex CLI Tool 使用说明.md|Codex CLI Tool 使用说明]]
- [[2. 实用工具/AI工具手册/Hermes Agent 安装配置命令与最佳实践.md|Hermes Agent 安装配置命令与最佳实践]]
- [[2. 实用工具/AI工具手册/OpenClaw 安装配置命令与最佳实践.md|OpenClaw 安装配置命令与最佳实践]]
- [[2. 实用工具/AI工具手册/OpenCode 安装配置命令与最佳实践.md|OpenCode 安装配置命令与最佳实践]]
- [[2. 实用工具/AI工具手册/Spec Kit 与 SDD 规范驱动开发实践指南.md|Spec Kit 与 SDD 规范驱动开发实践指南]]
- [[2. 实用工具/AI工具手册/Superpowers 安装使用与 AI 编程工作流实践指南.md|Superpowers 安装使用与 AI 编程工作流实践指南]]
- [[2. 实用工具/AI工具手册/YouTube 科技视频中文配音工作流最佳实践.md|YouTube 科技视频中文配音工作流最佳实践]]
- [[2. 实用工具/AI工具手册/claude-mem 自动记忆系统介绍.md|claude-mem 自动记忆系统介绍]]
- [[2. 实用工具/AI工具手册/gstack 概述与使用指南.md|gstack 概述与使用指南]]

### AI工具手册/Skills
- [[2. 实用工具/AI工具手册/Skills/Agent Skills 概述与索引.md|Agent Skills 概述与索引]]
- [[2. 实用工具/AI工具手册/Skills/Caveman Skill 安装使用指南.md|Caveman Skill 安装使用指南]]
- [[2. 实用工具/AI工具手册/Skills/Graphify Skill 安装使用指南.md|Graphify Skill 安装使用指南]]


## 3. 工作与业务

### 履历与项目经历
- [[3. 工作与业务/履历与项目经历/LinkLabel 标注平台项目经历.md|LinkLabel 标注平台项目经历]]
- [[3. 工作与业务/履历与项目经历/Sekiro 智能报销审批平台项目经历.md|Sekiro 智能报销审批平台项目经历]]
- [[3. 工作与业务/履历与项目经历/TPA 商业健康保险智能理赔服务平台项目经历.md|TPA 商业健康保险智能理赔服务平台项目经历]]
...
- [[3. 工作与业务/保险核赔业务/核赔、复核、回传与结案分流.md|核赔、复核、回传与结案分流]]
- [[3. 工作与业务/保险核赔业务/案件排查与诊断手册.md|案件排查与诊断手册]]
- [[3. 工作与业务/保险核赔业务/案件生产系统的全过程.md|案件生产系统的全过程]]
- [[3. 工作与业务/保险核赔业务/案件生命周期以及流程.md|案件生命周期以及流程]]
- [[3. 工作与业务/保险核赔业务/案件的理算设计.md|案件的理算设计]]
- [[3. 工作与业务/保险核赔业务/特殊概念、边界场景与历史词汇词典.md|特殊概念、边界场景与历史词汇词典]]
- [[3. 工作与业务/保险核赔业务/真实案件进件至结案全流程履约.md|真实案件进件至结案全流程履约]]
- [[3. 工作与业务/保险核赔业务/票据风控专题与风险处理手册.md|票据风控专题与风险处理手册]]
- [[3. 工作与业务/保险核赔业务/资金结算专题与状态流转手册.md|资金结算专题与状态流转手册]]
- [[3. 工作与业务/保险核赔业务/进件方式、流程类型与对接模式差异.md|进件方式、流程类型与对接模式差异]]
- [[3. 工作与业务/保险核赔业务/问题件、打回、恢复与回退手册.md|问题件、打回、恢复与回退手册]]


## 4. 思考与认知

### 思维模型
- [[4. 思考与认知/思维模型/高杠杆思维模型实战手册.md|高杠杆思维模型实战手册]]

### 语言学习
- [[4. 思考与认知/语言学习/英语单词学习最佳实践：词根词缀、词源与间隔重复.md|英语单词学习最佳实践：词根词缀、词源与间隔重复]]
- [[4. 思考与认知/语言学习/英语音标 IPA 学习笔记.md|英语音标 IPA 学习笔记]]
...
- [[6. 收集箱/JavaGuide 基础框架梳理草稿.md|JavaGuide 基础框架梳理草稿]]
- [[6. 收集箱/企业 Agent 落地四层工程进化论.md|企业 Agent 落地四层工程进化论]]
- [[6. 收集箱/刻意练习与反馈闭环.md|刻意练习与反馈闭环]]
- [[6. 收集箱/大语言模型基础-草稿.md|大语言模型基础-草稿]]
