...
按 [[01-大模型基础/LLM 运行机制：Token、上下文窗口与采样参数]] → [[01-大模型基础/大模型结构化输出：从 JSON 契约到 Function Calling 落地]] → [[01-大模型基础/LLM API 调用工程]] → [[02-Prompt 与上下文/Prompt 工程]] → [[02-Prompt 与上下文/上下文工程]] 的顺序推进。
